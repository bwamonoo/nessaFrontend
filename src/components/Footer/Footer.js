...
const Footer = () => {
  ...
  // Function to scroll to the top of the page when "back-to-top" is clicked
  const scrollToTop = () => {
    window.scrollTo({
      top: 0,
      behavior: 'smooth',
  ...
  return (
    <footer className="footer-container"> {/* Main container for the footer */}
      ...
      <div className="back-to-top" onClick={scrollToTop}>
        <FaArrowUp size={20} /> {/* Arrow icon for scrolling to top */}
      </div>

      {/* Footer content section */}
      <div className="footer-content">
        <div className="footer-logo">
          <img src={logo} alt="Nessa Logo" /> {/* Displaying the logo */}
        </div>
        ...
        {/* Terms of Service and Privacy Note link */}
        <a className='footer_ref' href=""><span style={{color:'rgb(125, 115, 192)'}}>Terms of service</span> and <span style={{color:'rgb(125, 115, 192)'}}>privacy note</span></a>
      </div>
